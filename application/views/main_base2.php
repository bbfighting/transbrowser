  ...
  <body>
            ...
            <div class="item active">
                <div class="container">
                    <div class="carousel-caption">
                        <h1>Predict</h1>
                        <form role="form" method="post" action="predict/submit" enctype="multipart/form-data">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="comment">Paste or type your sequence in FASTA format here :</label>
                                ...
                                <div class="form-inline">
                                    <label for="comment">Click your translation initiation start site :</label>
                                        <input class="selectpicker show-tick" name="startcoden" type="radio" value="aug"> AUG
    ...
    <div class="container marketing">
      ...
      <footer>
        ...
        <p>Copyright &copy; 2015, National Cheng Kung University All rights reserved. Computational Systems Biology Laboratory</p>
      </footer>
    </div><!-- /.container -->
