...
class Page_parsexml extends CI_Model { 
    ...
    {
        //include_once("/home/testuser/public_html/IRES_test/Entrez/cores/core_common.php");
        ...
        if (file_exists($xmlpath))
        {
            ...
            $table_data['outputinfo_table'] = "<table><tr><td>#</td><td>start</td><td>end</td><td>#num IREZone</td></tr>";
